...
<body class="homepage-2">
  ...
  <div class="main">
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8">
            ...
            <div class="section-heading text-center">
              <h2>Explore Proposed Features</h2>
        ...
        <div class="row">
          <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="icon-box text-center p-4 wow fadeInUp" data-wow-duration="2s">
              ...
              <!-- Icon Text -->
              <div class="icon-text">
                <h3 class="mb-2">Search HouseKeepers</h3>
                <p>
                  Your can search keepers to based on certain characteristics (name, location, origin, religion...)
                  and get access to keepers that suites you desire.
                </p>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="icon-box text-center p-4 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.2s">
              ...
              <!-- Icon Text -->
              <div class="icon-text">
                <h3 class="mb-2">Place a Task</h3>
                <p>
                  After finding your worker, Place a task and set the proposed informations (description, price per hour, duration...)
                  and follow the progression of the task as it is beeing processed.
                </p>
              </div>
            </div>
          </div>
          <div class="col-12 col-md-6 col-lg-4">
            ...
            <div class="icon-box text-center p-4 wow fadeInUp" data-wow-duration="2s" data-wow-delay="0.4s">
              ...
              <!-- Icon Text -->
              <div class="icon-text">
                <h3 class="mb-2">Chat with your keeper</h3>
                <p>
                  In the app integrated chat, initiate a chat with the keeper you want to affect the task to so as to align yourselves
                  about the requirements and the expectations.
                </p>
              </div>
            </div>
          </div>
            ...
            <div class="discover-text px-0 px-lg-4 pt-4 pt-lg-0">
              ...
              <ul class="check-list">
                ...
                <li class="py-1">
                  <div class="list-box media">
                    <span class="icon align-self-center"><i class="fas fa-check"></i></span>
                    <span class="media-body pl-3">Natus error sit voluptatem unde omnis iste natus error sit voluptatem accusantium.</span>
                  </div>
                </li>
                <li class="py-1">
                  <div class="list-box media">
          ...
          <div class="col-12 col-md-10 col-lg-8">
            <div class="work-content text-center">
              ...
              <p class="d-none d-sm-block text-white my-3 mt-sm-4 mb-sm-5">
                Go through the following steps to install the app and enjoy the services we put at your disposal.
              </p>
              <p class="d-block d-sm-none text-white my-3">
                Go through the following steps to install the app and use it.
              </p>
            </div>
          </div>
        </div>
        <div class="row">
          <div class="col-12 col-md-4">
            <div class="single-work text-center p-3">
              ...
              <p class="text-white">
                Go to PlayStore and install the app, or move to the
                <a href="https://github.com/samajestedigho/housekeeper" target="_blank"><span style="color: red;">github repository</span></a>
          ...
          <div class="col-12 col-md-4">
            <div class="single-work text-center p-3">
              ...
              <p class="text-white">
                Create an account, setup your profile, name, location, theme...
              </p>
            </div>
          </div>
          ...
          <div class="col-12 col-md-4">
            <div class="single-work text-center p-3">
              ...
              <p class="text-white">
                All being set up, you can now start exploring and enjoying our services.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8">
            <div class="section-heading text-center">
              ...
              <p class="d-none d-sm-block mt-4">
                Admire the power beautiful and simple to use interfaces.
              </p>
              <p class="d-block d-sm-none mt-4">
                Admire the power beautiful and simple to use interfaces.
              </p>
    ...
    <!-- ***** ======================================= ***** -->
    <section id="about" class="section testimonial-area ptb_100">
          ...
          <div class="col-12 col-md-10 col-lg-8">
            <div class="testimonials owl-carousel">
              ...
              <div class="single-testimonial p-3 p-md-5">
                <img src="{{ asset('assets/images/avatar.jpg') }}" class="mx-auto d-block" alt="">
                <!-- Client Name -->
                <h4 class="client-name mt-4 mb-2">Jordan DIGHO</h4>
                <!-- Client Address -->
                <h6 class="client-address fw-4">Weifang, Shandong</h6>
                <!-- Client Rating -->
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-8">
            ...
            <div class="section-heading text-center">
              ...
              <p class="d-none d-sm-block mt-4">
                If after scrolling through all this you still have some inqueries, check frequently asked questions or contact us.
              </p>
              <p class="d-block d-sm-none mt-4">
                If after scrolling through all this you still have some inqueries, check frequently asked questions or contact us.
              </p>
                    ...
                    <div class="card border-top-0 border-left-0 border-right-0 border-bottom">
                      ...
                      <div class="card-header bg-inherit border-0 p-0">
                        <h2 class="mb-0">
                          <button class="btn px-0 py-3" type="button" data-toggle="collapse" data-target="#collapseOne">
                            How to install HouseKeeper Finder?
                          </button>
                        </h2>
                      </div>
                      <div id="collapseOne" class="collapse show" data-parent="#sApp-accordion">
                        ...
                        <div class="card-body px-0 py-3">
                          Download the app on Playstore on from this
                          <a href="https://github.com/samajestedigho/housekeeper" target="_blank"><span style="color: red;">github repository</span></a>
                          and follow the instaructions.
                        </div>
                      </div>
                    </div>
        ...
        <div class="row justify-content-center">
          <div class="col-12 col-md-10 col-lg-9">
            ...
            <div class="download-text text-center">
              <h2 class="text-white">HouseKeeper is actually available only for Android phones </h2>
              <p class="text-white my-3 d-none d-sm-block">Can be download on Playstore or on github</p>
              <p class="text-white my-3 d-block d-sm-none">Can be download on Playstore or on github</p>
              <!-- Store Buttons -->
              ...
              <span class="d-inline-block text-white fw-3 font-italic mt-3">* Available on all Android devices</span>
            </div>
          </div>
        </div>
      </div>
          ...
          <div class="row">
            <div class="col-12 col-sm-6 col-lg-3">
              ...
              <div class="footer-items">
                ...
                <p class="mt-2 mb-3">
                  A new vision for a new way of looking through the world and refassion it the better way.
                </p>
                <!-- Social Icons -->
                <div class="social-icons d-flex">
                  ...
                  <a class="google-plus" href="https://www.google.com/dighodonmezatankeujordan@gmail.com">
  ...
  <!-- Active js -->
  <script src="{{ asset('assets/js/landing/active.js') }}"></script>
</body>

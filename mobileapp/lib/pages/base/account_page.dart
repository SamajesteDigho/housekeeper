          ...
          child: Stack(
            children: [
              SizedBox(
                ...
                child: Image.network('${controller.user.avatar}', fit: BoxFit.cover),
              ),
              Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        Text(
                                          '${controller.user.firstname?.toUpperCase()} ${controller.user.lastname}',
                                ...
                                children: [
                                  Expanded(
                                    child: Column(
                                      children: [
                                        Text(
                                          '${MyUtilities.getAge(controller.user.birthdate)} years',
                                          style: const TextStyle(
                                            fontWeight: FontWeight.bold,
                                            fontSize: AppDimension.mediumText,
                                          ),
                    ...
                    Container(
                      ...
                      child: Column(
                        children: [
                          ...
                          // ),
                          // const Divider(),
                          controller.user.role != 'HOUSEKEEPER'
                              ? ListTile(
                                  title: const Text(
                                    "Become a Worker",
                                    style: TextStyle(
